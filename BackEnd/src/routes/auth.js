...
authRouter.post('/sign-up/admin', authMiddleware.verifyToken, authValidation.userSignUpValidation, authValidation.checkDuplicateUser, authMiddleware.createUser,  authController.adminSignUp);
