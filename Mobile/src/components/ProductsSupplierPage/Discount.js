        ...
        <View style = {style.View}>
            ...
            <View style = {style.price}>
                <View style = {style.name}>
                    <Text style = {{...style.textPrice, color: '#000'}}>{data.name}</Text>
                </View>
                <View style = {style.value}>
                    <Text style = {style.textPrice}>Discount {data.value}%</Text>
                    
                </View> 
                
            </View>
            <TouchableOpacity style= {style.delete} onPress={()=>{deleteDiscount(data.key)}}>
